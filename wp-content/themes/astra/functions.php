...
add_shortcode('user_login', 'user_login_function', 10);
function user_login_function(){
   
    if ( !is_user_logged_in() ) {
       // your code for logged in user 
        ?> <a href="http://localhost/truefirms-forum/login/" id="header-login-btn">Login</a> <?php
    } else {
      ?><a href="http://localhost/truefirms-forum/profile/"> <i class='fas fa-user-alt' id="header-profile-icon"></i> </a> <?php
    }
}
